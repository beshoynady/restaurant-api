...
function App() {
  ...
  const getProducts = async () => {
    const products = await axios.get('https://restaurant-api-fawn.vercel.app/api/product')
  ...
  const getCategories = async () => {
    try {
      const allcategories = await axios.get('https://restaurant-api-fawn.vercel.app/api/category')
  ...
  const getalltable = async () => {
    const tables = await axios.get('https://restaurant-api-fawn.vercel.app/api/table');
  ...
  const getallusers = async () => {
    const users = await axios.get('https://restaurant-api-fawn.vercel.app/api/user');
  ...
  const createclientorder = async (queryid) => {
    ...
    if (queryid) {
      if (lasttableorderactive) {
        ...
        const status = 'انتظار'
        const neworder = await axios.put('https://restaurant-api-fawn.vercel.app/api/order/' + id, {
        ...
        try {
          ...
          if (user) {
            const order_type = 'ديلفري'
            const neworder = await axios.post('https://restaurant-api-fawn.vercel.app/api/order', {
              serial,
              table,
              user,
              products,
  ...
  const invoice = async (queryid) => {
    ...
    if (queryid) {
      if (lasttableorderactive) {
        const id = await lasttableorder._id
        const myorder = await axios.get('https://restaurant-api-fawn.vercel.app/api/order/' + id,)
        ...
        //   const findprduct = await axios.get('https://restaurant-api-fawn.vercel.app/api/product/' + productid)
        ...
        //   const updatprduct = await axios.put('https://restaurant-api-fawn.vercel.app/api/product/withoutimage/' + productid,{
        //     sales
        //   })
  ...
  const signup = async (e, username, password, phone, address, email) => {
    e.preventDefault()
    try {
      const newclient = await axios.post('https://restaurant-api-fawn.vercel.app/api/auth/signup', { username, password, phone, address, email })
  ...
  const login = async (e, phone, password) => {
    ...
    try {
      const client = await axios.post('https://restaurant-api-fawn.vercel.app/api/auth/login', { phone, password })
