...
const Employees = () => {
  ...
  const getemployees = async () => {
    try {
      const response = await axios.get('https://restaurant-api-theta.vercel.app/api/user')
  ...
  const createEmployee = async (e) => {
    ...
    try {
      const newemployee = await axios.post('https://restaurant-api-theta.vercel.app/api/user', { username, password, address, phone, email, isAdmin, role, salary })
  ...
  const updateEmployee = async (e) => {
    ...
    try {
      if(password){
      const update = await axios.put('https://restaurant-api-theta.vercel.app/api/user/' + userid, { username, password, address, phone, email, isAdmin, role, salary })
      console.log(update)
      if(update){
        getemployees()
      }
  }else{
      const update = await axios.put('https://restaurant-api-theta.vercel.app/api/user/' + userid, { username, address, phone, email, isAdmin, role, salary })
      console.log(update)
      if(update){
        getemployees()
    } 
  ...
  const deleteEmployee = async (e) => {
    ...
    try {
      console.log(userid)
      const deleted = await axios.delete(`https://restaurant-api-theta.vercel.app/api/user/${userid}`)
      if(deleted){
      console.log(deleted)
      getemployees()
    }
