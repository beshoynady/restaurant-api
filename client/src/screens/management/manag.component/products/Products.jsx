...
const Products = () => {
  ...
  const createProduct = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://restaurant-api-fawn.vercel.app/api/product/', formdata);
  ...
  const editProduct = async (e) => {
    ...
    if (productimg) {
      try {
        const response = await axios.put('https://restaurant-api-fawn.vercel.app/api/product/' + productid, {
      ...
      try {
        const response = await axios.put('https://restaurant-api-fawn.vercel.app/api/product/withoutimage/' + productid, {
  ...
  const getallproducts = async () => {
    try {
      const response = await axios.get('https://restaurant-api-fawn.vercel.app/api/product/');
  ...
  const deleteProduct = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.delete(`https://restaurant-api-fawn.vercel.app/api/product/${productid}`);
      if (response) {
  ...
  const getallCategories = async () => {
    try {
      const response = await axios.get('https://restaurant-api-fawn.vercel.app/api/category/');
                ...
                if (i < pagination & i >= pagination - 5) {
                  return (
                    <tr key={i}>
                      ...
                      <td>{i + 1}</td>
                      <td><img src={`https://restaurant-api-fawn.vercel.app/${p.image}`} style={{ "width": "60px", "height": "50px" }} /></td>
                      <td>{p.name}</td>
                      <td>{p.description}</td>
