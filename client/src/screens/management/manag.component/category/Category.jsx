...
const Category = () => {
  ...
  const createCategory = async () => {
    const send = await axios.post("http://localhost:8000/api/category/", { name: categoryname });
  }
  ...
  const editCategory = async () => {
    ...
    try {
      const edit = await axios.put("http://localhost:8000/api/category/" + categoryId, { name: categoryname })
      console.log(edit)
    } catch (error) {
      console.log(error)
    }
  ...
  const deleteCategory = async () => {
    try {
      const deleted = await axios.delete("http://localhost:8000/api/category/" + categoryId)
      console.log(categoryId)
      console.log(deleted)
    } catch (error) {
      console.log(error)
