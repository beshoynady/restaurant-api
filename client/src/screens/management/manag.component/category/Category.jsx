...
const Category = () => {
  ...
  const getallCategory = async () => {
    const res = await axios.get("https://restaurant-api-delta.vercel.app/api/category/");
    setallCategory(res.data)
  }


  const createCategory = async () => {
    const send = await axios.post("https://restaurant-api-delta.vercel.app/api/category/", { name: categoryname });
  }
  ...
  const editCategory = async () => {
    ...
    try {
      const edit = await axios.put("https://restaurant-api-delta.vercel.app/api/category/" + categoryId, { name: categoryname })
      console.log(edit)
    } catch (error) {
      console.log(error)
    }
  ...
  const deleteCategory = async () => {
    try {
      const deleted = await axios.delete("https://restaurant-api-delta.vercel.app/api/category/" + categoryId)
      console.log(categoryId)
      console.log(deleted)
    } catch (error) {
      console.log(error)
