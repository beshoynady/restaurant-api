...
const Tables = () => {
  ...
  const createQR = async (e) => {
    ...
    const qr = await axios.post('http://localhost:8000/api/table/qr', { URL });
    // console.log(qr.data);
    setqrimage(qr.data);
  }
  ...
  const createTable = async (e) => {
    ...
    // console.log(chairs)
    try {
      const response = await axios.post('http://localhost:8000/api/table/', { "description": tabledesc, tablenum, chairs });
      console.log(response.data);
      getallTable();
    } catch (error) {
      console.log(error)
  ...
  const editTable = async (e) => {
    ...
    // console.log(chairs)
    try {
      const response = await axios.put(`http://localhost:8000/api/table/${tableid}`, { "description": tabledesc, tablenum, chairs });
      console.log(response.data);
      getallTable();
    } catch (error) {
      console.log(error)
  ...
  const deleteTable = async (e) => {
    ...
    // console.log(tableid)
    try {
      const response = await axios.delete(`http://localhost:8000/api/table/${tableid}`);
      console.log(response.data);
      settableid(null);
      getallTable();
    } catch (error) {
