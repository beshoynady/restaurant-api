...
const Tables = () => {
  ...
  const createQR = async (e) => {
    ...
    const qr = await axios.post('https://restaurant-api-delta.vercel.app/api/table/qr', { URL });
    // console.log(qr.data);
    setqrimage(qr.data);
  }
  ...
  const getallTable = async () => {
    try {
      const response = await axios.get('https://restaurant-api-delta.vercel.app/api/table');
  ...
  const createTable = async (e) => {
    ...
    // console.log(chairs)
    try {
      const response = await axios.post('https://restaurant-api-delta.vercel.app/api/table/', { "description": tabledesc, tablenum, chairs });
      console.log(response.data);
      getallTable();
    } catch (error) {
      console.log(error)
  ...
  const editTable = async (e) => {
    ...
    // console.log(chairs)
    try {
      const response = await axios.put(`https://restaurant-api-delta.vercel.app/api/table/${tableid}`, { "description": tabledesc, tablenum, chairs });
      console.log(response.data);
      getallTable();
    } catch (error) {
      console.log(error)
  ...
  const deleteTable = async (e) => {
    ...
    // console.log(tableid)
    try {
      const response = await axios.delete(`https://restaurant-api-delta.vercel.app/api/table/${tableid}`);
      console.log(response.data);
      settableid(null);
      getallTable();
    } catch (error) {
