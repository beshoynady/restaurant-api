...
const ManagerDash = () => {
  ...
  const PendingOrder = async () => {
    const res = await axios.get('https://restaurant-api-fawn.vercel.app/api/order')
  ...
  const changeorderstauts = async (e, id) => {
    try {
      ...
      const order = await axios.put('https://restaurant-api-fawn.vercel.app/api/order/' + id, {
        status
      })
  ...
  const changePaymentorderstauts = async (e, id) => {
    try {
      ...
      const order = axios.put('https://restaurant-api-fawn.vercel.app/api/order/' + id, {
        payment_status
      })
      setupdate(!update)
    } catch (error) {
